...
import com.bai.android.data.roster.Group;
import com.bai.android.data.roster.GroupManager;
import com.bai.android.data.roster.GroupStateProvider;
...
//			ArrayList<AbstractContact> contacts, boolean showAccounts,
			ArrayList<AbstractContact> contacts,
			boolean showGroups) {
//		if (showAccounts) {
...
//		}
	...
	public void toggleMucSelector() {
		Inflater.toggleMucSelector();
	}
