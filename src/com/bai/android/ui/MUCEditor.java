...
import com.bai.android.ui.adapter.AccountChooseAdapter;
...
public class MUCEditor extends ManagedActivity implements View.OnClickListener,
	 ...
	 */
	private static final String ACTION_MUC_INVITE = "com.bai.android.data.MUC_INVITE";

	private static final String SAVED_ACCOUNT = "com.bai.android.ui.MUCEditor.SAVED_ACCOUNT";
	private static final String SAVED_ROOM = "com.bai.android.ui.MUCEditor.SAVED_ROOM";
...
//		if (roomInvite != null) showDialog(DIALOG_MUC_INVITE_ID); SKIP DIALOG "Do you want to join conference"
		proceedToRoom(); //direclty send a join ;
	}
