 ...
 */
package com.bai.android.ui.widget;
...
import com.bai.android.ui.adapter.SaveStateAdapter;
...
public class PageSwitcher extends ViewGroup implements AnimationListener {
	...
	private void showPages() {
		...
		if (selectedView != null) {
			...
			selectedView.findViewById(R.id.chat_page).setVisibility(View.VISIBLE);
		}
		if (visibleView != null) {
			visibleView.findViewById(R.id.chat_page).clearAnimation();
			visibleView.findViewById(R.id.chat_page).setVisibility(View.VISIBLE);
		}
	}
