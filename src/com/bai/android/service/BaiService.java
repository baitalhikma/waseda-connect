 ...
 */
package com.bai.android.service;
...
public class BaiService extends Service {
	...
	private static BaiService instance;

	public static BaiService getInstance() {
		return instance;
	}
	...
	@SuppressWarnings("deprecation") //ADDRSSED by onStartCommand
	@Override
	...
	public static Intent createIntent(Context context) {
		return new Intent(context, BaiService.class);
	}
