...
import com.bai.android.data.OnUnloadListener;
...
import com.bai.android.data.account.OnAccountSyncableChangedListener;
...
import com.bai.android.utils.DummyCursor;
...
public class SyncManager implements OnLoadListener, OnUnloadListener,
	...
	private void onLoaded(Collection<RosterContact> rosterContacts,
		...
		for (String account : com.bai.android.data.account.AccountManager
				.getInstance().getAllAccounts()) {
			AccountItem accountItem = com.bai.android.data.account.AccountManager
			...
			public void run() {
				for (String account : accounts) {
					LogManager.w(this, "Disable synchronization for: "
							+ account);
					if (com.bai.android.data.account.AccountManager
							.getInstance().getAccount(account) != null)
						com.bai.android.data.account.AccountManager
