...
import com.bai.android.data.entity.NestedMap.Entry;
...
public class GroupManager implements OnLoadListener, OnAccountRemovedListener,
	 ...
	 */
	public static final String IS_ROOM = "com.bai.android.data.IS_ROOM";

	/**
	 * Reserved group name for active chat group.
	 */
	public static final String ACTIVE_CHATS = "com.bai.android.data.ACTIVE_CHATS";

	/**
	 * Reserved group name to store information about group "out of groups".
	 */
	public static final String NO_GROUP = "com.bai.android.data.NO_GROUP";

	/**
	 * Group name used to store information about account itself.
	 */
	public static final String IS_ACCOUNT = "com.bai.android.data.IS_ACCOUNT";

	/**
	 * Account name used to store information that don't belong to any account.
	 */
	public static final String NO_ACCOUNT = "com.bai.android.data.NO_ACCOUNT";
