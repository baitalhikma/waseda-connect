...
import com.bai.android.data.connection.NetworkManager;
...
import com.bai.android.ui.adapter.ComparatorByName;
import com.bai.android.ui.adapter.ComparatorByStatus;
...
public class SettingsManager implements OnInitializedListener,
	...
	public static EventsMessage eventsMessage() {
		String value = getString(R.string.events_message_key, R.string.events_message_default);
		if (Application.getInstance().getString(R.string.events_message_none_value).equals(value)) {
			return EventsMessage.none;
		} else if (Application.getInstance().getString(R.string.events_message_chat_value).equals(value)) {
			return EventsMessage.chat;
		} else if (Application.getInstance().getString(R.string.events_message_chat_and_muc_value).equals(value)) {
