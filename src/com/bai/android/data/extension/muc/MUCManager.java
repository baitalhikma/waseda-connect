...
public class MUCManager implements OnLoadListener, OnPacketListener, InvitationCallback {
	...
	public class PersistentMUCChats {
		public final static String GLOBAL = "globalMUCname@muc.hostname";
		public final static String RECOMMENDED = "recommendationsMUCname@muc.hostname";
		public final static String NOTICE = "noticesMUCname@muc.hostname";
	}
	...
	public String createJoinInviteRoom(String account, ArrayList<BaseEntity> users, String nickname, String password) {
		...
		roomNameBuild.append("@muc.hostname");
...
//			}
			...
			if (xmppcon != null && xmppcon.isConnected() && xmppcon.isAlive()) {
				...
				try {
					...
					if (roomInfo != null) {
						//						joinRoom(account, roomName, true);
						MUCManager.getInstance().createRoom(account, roomName, AccountManager.getInstance().getNickName(account), null, true); //TODO - NICKNAME
						return;
					}
				...
				try {
					...
					//					submitForm.setAnswer("muc#roomconfig_maxusers", 250); //TODO TOO LITTLE?
					submitForm.setAnswer("muc#roomconfig_membersonly", false);
					submitForm.setAnswer("muc#roomconfig_roomdesc", "Test persistent room description"); //TODO
