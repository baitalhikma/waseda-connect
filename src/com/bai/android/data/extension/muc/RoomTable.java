...
import com.bai.android.data.entity.AbstractAccountTable;
...
class RoomTable extends AbstractAccountTable {
	...
	void write(String account, String room, String nickname, String password, boolean join) {
		synchronized (writeLock) {
			if (writeStatement == null) {	//DOESN WORK
...
//			SQLiteDatabase db = databaseManager.getWritableDatabase();	//THIS WORKS
//			if (password != null) password = "'" + password + "'";
//			int joinInt = join ? 1 : 0;
//			String sql = "INSERT INTO " + NAME + " (`"+ Fields.ACCOUNT+"`,`"+ Fields.ROOM+"`,`"+ Fields.NICKNAME+"`,`"+ Fields.PASSWORD+"`,`"+ Fields.NEED_JOIN+"`)"+
//					" VALUES('"+account + "','" + room + "','" + nickname+"'," + password + "," + joinInt + ");";
//			DatabaseManager.execSQL(db, sql);
		}
	}

	// returns all rooms in the db
