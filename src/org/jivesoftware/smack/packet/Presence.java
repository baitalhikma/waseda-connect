...
public class Presence extends Packet {
    ...
    /** Hash for broadcasting a change in the avatar photo. */
    ...
    public String toXML() {
        ...
        if (getPhotoHash() != null) {
        	buf
        	.append("<x xmlns=\"vcard-temp:x:update\">")
	        	.append("<photo>")
	        		.append(getPhotoHash())
	        	.append("</photo>")
        	.append("</x>");
	...
	/** Set the gash for broadcasting aftaer change in the avatar photo. */
