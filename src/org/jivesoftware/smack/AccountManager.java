...
//	public void createAccount(String username, String password, HashMap<String, String> attributes) throws XMPPException {
...
//	}
//
//	public void addAccountAttributes(HashMap<String, String> attributes) {
//		Iterator iter = attributes.entrySet().iterator();
//		while (iter.hasNext()) {
//			Map.Entry pair = (Map.Entry) iter.next();
//			info.addAttribute(pair.getKey().toString(), pair.getValue().toString());
//		}
//	}
	 ...
	 * @returns creation result, null if no result
	 */
	public String createAccount(String username, String password, Map<String, String> attributes) throws XMPPException {
		...
		collector.cancel();
		if (response == null) {
			Log.e("Log Manager", "No response from server.");
			return "No response from server.";
//			throw new XMPPException("No response from server.");
		}
		else if (response.getType() == IQ.Type.ERROR) {
			Log.e("Log Manager", response.getError().getMessage());
			Log.e("Log Manager", "Error code: " + response.getError().getCode());
			return response.getError().getMessage() + ". Username may be taken.";
